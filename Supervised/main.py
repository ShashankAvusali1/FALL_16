...
[train_data, train_labels, test_data, test_labels] = split_train_test(data,labels,minority_count=100)
...
svc = SVC(C=bestparams['C'], kernel='rbf', gamma=bestparams['gamma'], shrinking=True, probability=False, class_weight={2:bestparams['Weight']}, tol=0.001, verbose=False)
